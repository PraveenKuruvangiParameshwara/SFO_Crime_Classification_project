...
\documentclass[11 pt,conference,final,]{IEEEtran}
...
%\hypersetup{
%            pdftitle={Intelligent Automation of SFO Crime Prediction using Multiple Artifical Intelligence Methods},
%            pdfkeywords={Artificial Intelligence, Machine Learning, Deep Learning, TabNet, Crime Pattern Theory},
%            pdfborder={0 0 0},
%            breaklinks=true}
...
\usepackage[margin=0.75in, right=0.63in, top=0.75in, bottom=1.05in]{geometry}
\setlength{\columnsep}{0.30in}  % Set gutter width to 0.24 inches
...
{\centering \includegraphics[width=0.85\linewidth]{img/fig1} 
