...
```{r,  out.width="75%", fig.cap="Webapp to identify the location and incidents",fig.align = "center", echo= FALSE}
...
```{r,  out.width="75%", fig.cap="Interactive map to facilitate different requirements",fig.align = "center", echo= FALSE}
