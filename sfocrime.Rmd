...
indnm <- c("Random Forest", "K Neighbor", "ANN", "TabNet", "TimeSeries", "Classes")

combdf <- cbind(indnm, clm1, clm2, clm3)

colnames(combdf) <- c("Model", "SFO(2003-2018)", "SFO(2018- 2022)", "Boston(2022)")
